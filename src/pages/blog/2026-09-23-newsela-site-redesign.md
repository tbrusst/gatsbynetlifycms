...
tags:
  ...
  - Visual Design
---
Newsela.com was underperforming at every level: traffic down 32% year-over-year, a navigation structure that broke down across sub-sites, and accessibility gaps that shut out real users. I led this project end-to-end as the sole designer, partnering closely with marketing, product marketing, product, sales, and web development to audit the entire site, update its architecture, and design and maintain refreshed components and modules.

#### Auditing the problem

![Q1 year-over-year web traffic audit showing users down 32.3% and new users down 34.4%, alongside goal conversion and top visited page tables](/img/brendanrusso_newselacom_trafficaudit.jpg "Newsela.com traffic and performance audit")

The performance scorecard made the scale of the problem concrete: users down 32.3% year over year, new users down 34.4%, alongside a goal conversion overview and a look at the top visited pages that showed where visitors were actually landing versus where we wanted them to go.

![Usability and accessibility audit findings, including confusing navigation, inconsistent sub-site experiences, WCAG contrast issues, and forms that were too intrusive](/img/brendanrusso_newselacom_usabilityaudit.jpg "Newsela.com usability and accessibility audit")

The usability and accessibility audit surfaced the specific issues driving that decline: a confusing navigation structure that opened multiple new windows, inconsistent experiences across the pre-auth site, Marketo pages, and Uberflip content, mismatched footers, visual clutter, a confusing content download flow, WCAG contrast issues with Newsela's own blue, a site that wasn't optimized for mobile, and forms that interrupted the browsing experience more than they helped it.
