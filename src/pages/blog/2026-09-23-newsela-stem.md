...
The key piece of the launch was a product page for Newsela STEM that could express the value of the new offering quickly. I designed a wireframe and worked alongside our development and product marketing teams to stand it up for launch, built around a "Make Real-World Science Relevant" hero and a set of tabs covering curiosity, deeper learning, cross-curricular connections, and classroom-ready resources.

Folding an acquisition into an existing product line under real launch pressure is exactly the kind of test a brand system needs to survive. Newsela STEM shipped with a lockup, a color system, and a full marketing and product launch built on the same rules as everything else in the Newsela family, so it never read as a separate, bolted-on brand.